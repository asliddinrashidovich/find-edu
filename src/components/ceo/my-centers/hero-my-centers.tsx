  ...
  return (
    <section className="hero_my_centers overflow-hidden relative justify-between flex items-center h-[100vh]">
        <div className="px-[10px] md:px-[50px] relative flex flex-col justify-center items-center w-full z-10">
            <h2 data-aos="fade-right" className="text-[#fff] text-[30px] sm:text-[50px] md:text-[75px] max-w-[1200px] mx-auto font-[700] text-center leading-[110%] mb-[50px]">{`Men yaratgan o'quv markazlar.`}</h2>
        ...
        <a href="#my_centers_mainsection" className="jumb_button absolute  bottom-[10px] z-10 left-[50%] translate-x-[-50%]">
